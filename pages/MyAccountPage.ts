...
export class MyAccountPage {
    ...
    constructor(page: Page) {
        ...
        this.msgHeading = page.locator('//h2[normalize-space()="My Account"]');
    ...
    async isMyAccountPageExists(): Promise<boolean> {
        try {
            ...
            await expect(this.msgHeading).toBeVisible();
            //const isVisible = await this.msgHeading.isVisible();
            //const isVisible = await this.page.getByRole('heading',{name:}).isVisible();
            return true;
        } catch (error) {
