...
export class ProductPage {
    ...
    private readonly lblViewCart:Locator;
    ...
    constructor(page: Page) {
        ...
        this.btnItems = page.locator('#button-cart');
        this.lnkViewCart = page.locator('strong:has-text("View Cart")');
        this.lblViewCart = page.locator('//span[@id="cart-total"]');
        this.linkViewCart = page.locator('//strong[normalize-space()="View Cart"]');
    }
    ...
    async clickItemsToNavigateToCart(): Promise<void> {
        ...
        console.log("ADD TO CAR BUTTON CLICKED");
    }
    ...
    async clickViewCart(): Promise<ShoppingCartPage> {
        await this.lnkViewCart.click({timeout:60000});
        return new ShoppingCartPage(this.page);
    }*/

    async clickGoCartPage(): Promise<ShoppingCartPage> {
        
        await this.lblViewCart.click();
